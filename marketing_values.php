<?php $logo_one_items = Array('HYPER','COMPU','MEGA','ULTRA','GLOBAL','SELL','MAXI','NET','SUPER','CLICK','WEB','SOCIAL','BUILD','BOOST','HERO','INTRA','RAD');

$logo_two_items = Array('COMM','LEADS','BLAST','SERGY','GLOBAL','GENIUS','SOCIAL','BOOST','NET','COM','ZAZZ','POP','SWELL','BEAST','FLOW','MONEYS','BONE');  

$global_leader_in = Array('ROI','Web-Alytics','market-driven cross-synergy','socially-empowered e-tailing','synergy mediaries',);

$bs_number_one = Array('thousands','millions','billions','trillions','quadrillions','bajillions');
...
$header_banner_noun_one = Array("synergies", "web-readiness", "paradigms", "markets", "partnerships", "infrastructures", "platforms", 
